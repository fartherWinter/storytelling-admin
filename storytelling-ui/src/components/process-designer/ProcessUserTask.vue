<template>
  <div 
    :class="['process-node', 'user-task', { selected: isSelected, preview: isPreview }]"
    :style="nodeStyle"
    @click="handleClick"
  ...
  >
    ...
    <!-- 节点标签 -->
    <div class="node-label">{{ nodeData.label || '用户任务' }}</div>
    
    <!-- 任务信息 -->
    <div v-if="nodeData.properties?.assignee" class="node-info">
      <span class="assignee">{{ nodeData.properties.assignee }}</span>
    </div>
